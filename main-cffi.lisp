...
(defcfun "jcm_return_dynamic_string" :pointer)
...
(defun run-pointers ()
  ...
  (let ((retval (jcm-return-dynamic)))
    (format t "Returned pointer char value: ~A~%" (code-char (mem-ref retval :char)))
    (setf (mem-ref retval :char) (char-code #\A))
    (jcm-free-dynamic retval)
    (format t "Pointer freed: ~A~%" (code-char (mem-ref retval :char))))
  (let ((retval (jcm-return-dynamic-string)))
    (format t "Returned pointer string value: ~A~%" (foreign-string-to-lisp retval))
    (jcm-free-dynamic retval)
    (format t "Pointer freed: ~A~%" (foreign-string-to-lisp retval))
    (format t "Pointer freed.~%")))
